...
public class DateTimeUtils {
    ...
    private static String convertDayIntToString(Context context, int day) {
        if (day == 1)
    ...
    private static int convertMonthStringToInt(Context context, String month) {
    ...
    static String formattedDate(Context context, int dayOfWeek, int month, int dayOfMonth, int year) {
        return convertDayIntToString(context, dayOfWeek) + ", " + convertMonthIntToStringShort(context, month) + " " + dayOfMonth + ", " + year;
    }
